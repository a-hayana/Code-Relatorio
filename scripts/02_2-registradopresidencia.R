...
qtd_total_pres_min <- full_recebidos |>
 ...
 saveRDS(qtd_total_pres_min, file = "data_raw/qtd_total_pres_min.rds")
...
qtd_recursal_pres_min <- full_recebidos |>
 ...
 saveRDS(qtd_recursal_pres_min, file = "data_raw/qtd_recursal_pres_min.rds")
...
qtd_recursal_pres_min_2 <- full_recebidos |>
 ...
 saveRDS(qtd_recursal_pres_min_2, file = "data_raw/qtd_recursal_pres_min_2.rds")
