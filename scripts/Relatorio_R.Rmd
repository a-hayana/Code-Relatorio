...
```{r acervo_total, echo=FALSE, warning=FALSE}
...
```{r acervo_originario_recursal, echo=FALSE, warning=FALSE}
...
ggplot(dados, aes(x = Ano, y = Processos)) +
  ...
  labs(caption = "Fonte: Portal de Informações Gerenciais em 01/12/2021 e Relatório de Atividades 202.")+
  geom_label(aes(label = Processos),
             position = position_dodge(0.9), 
             vjust = 0.5, size = 3.5, hjust = 0.5)+
  scale_fill_brewer(palette = "Blues") +
